...
const Home = (props) => {
  return (
    <div className="home-container">
      ...
      <div data-role="Header" className="home-navbar-container">
        <div className="home-navbar">
          ...
          <div className="home-links-container">
            ...
            <a href="#iletisim" className="home-link02 Navbar-Link">
              Contact
            </a>
          </div>
          ...
          <div data-role="MobileMenu" className="home-mobile-menu">
            ...
            <div className="home-links-container1">
              <span className="home-link03 Navbar-Link">About</span>
              <span className="home-link04 Navbar-Link">Experience</span>
      ...
      <div className="home-hakkmda">
        ...
        <div className="home-container05">
          <span className="home-text11">
            ...
            Technical University. We have been providing computer repair and
            maintenance services in our office for more than 10 years. For the
            last few years, I want to advance in the field of cyber security and
            I have been working on it. Apart from these, I have been interested
            in website design since the pandemic period. In the future, I want
            to focus on cloud systems.
          </span>
          <div className="home-container06"></div>
        </div>
        <div id="deneyim" className="home-container07"></div>
      </div>
          ...
          <div className="home-container08">
            <div className="home-step">
              <div className="home-container09">
                ...
                <span className="home-text14">
                  <span>
                    A Python training that progresses with the learning
                    structure
                    <span
                      dangerouslySetInnerHTML={{
                        __html: ' ',
                  ...
                  <br></br>
                  <span>brought by the YetGen culture</span>
                  <br></br>
                </span>
              </div>
            </div>
            <div className="home-step1">
              <div className="home-container10">
                <h1 className="home-text19">Sky-Sec</h1>
                <span className="home-text20">
                  <span>
                    A team of Yıldız Technical University Sky-Lab Club
                  </span>
                  <br></br>
                  <span> carrying out Cyber Security activities</span>
                </span>
              </div>
            </div>
            <div className="home-step2">
              <div className="home-container11">
                <h1 className="home-text24">YetGen</h1>
                <span className="home-text25">
                  <span>
                    A program that focuses on critical issues such as teamwork
                  ...
                  <br></br>
                  <span>aiming to gain 21st Century Competencies.</span>
                  <br></br>
                </span>
              </div>
            </div>
      ...
      <div id="iletisim" className="home-container12"></div>
      <div className="home-subscribe">
        <div className="home-container13">
          <span className="home-text30">Contact</span>
          <div className="home-container14">
            <div className="home-container15">
              <div className="home-container16">
                <div className="home-container17">
                  <a
                    href="mailto:talhayigityagiz@gmail.com?subject=Talha Yiğit Yağız"
